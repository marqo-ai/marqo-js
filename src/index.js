...
* <pre>
* var Marqo = require('index'); // See note below*.
* var xxxSvc = new Marqo.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new Marqo.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new Marqo.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new Marqo.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
